...
function AdminAboutPage() {
    ...
    const { data: about, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'admin-about'
        ],
        queryFn: {
            "AdminAboutPage.useQuery": ()=>fetch('/api/data?type=about').then({
                    "AdminAboutPage.useQuery": (res)=>res.json()
                }["AdminAboutPage.useQuery"])
        }["AdminAboutPage.useQuery"]
    });
    ...
    const mutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "AdminAboutPage.useMutation[mutation]": (updatedData)=>fetch('/api/data?type=about', {
                    method: 'POST',
        ...
        }["AdminAboutPage.useMutation[mutation]"],
        onSuccess: {
            "AdminAboutPage.useMutation[mutation]": ()=>{
    ...
    if (isLoading || !formData) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AdminAboutPage, "ChvjGvHaOrfnf7fWeW/7FnrkDqU=", false, function() {
    return [
...
//# sourceMappingURL=_4cbaf4d4._.js.map